...
/*		om.setVisibilityChecker(
	...
	private <T> ResponseEntity<T> processRequestBase(String url, Map<String, String> obj, Class<T> response,
													 HttpMethod method) {
	...
	private <T> ResponseEntity<T> processRequestBase(String url, Object request, Class<T> response, HttpMethod method) {
	...
	private <T> ResponseEntity<T> processRequestBase(String url, List<Map<String, String>> obj, Class<T> response,
													 HttpMethod method) {
		HttpHeaders headers = getBasicHeaders();
		HttpEntity<String> request = null;
		UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url);
